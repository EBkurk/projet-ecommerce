 ...
 */
class CategoryShop extends \App\Entity\CategoryShop implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\CategoryShop' . "\0" . 'id', '' . "\0" . 'App\\Entity\\CategoryShop' . "\0" . 'name', '' . "\0" . 'App\\Entity\\CategoryShop' . "\0" . 'slug', '' . "\0" . 'App\\Entity\\CategoryShop' . "\0" . 'products'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CategoryShop $proxy) {
