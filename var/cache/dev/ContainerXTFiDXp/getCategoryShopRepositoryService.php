 ...
 */
class getCategoryShopRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CategoryShopRepository' shared autowired service.
     *
     * @return \App\Repository\CategoryShopRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CategoryShopRepository.php';

        return $container->privates['App\\Repository\\CategoryShopRepository'] = new \App\Repository\CategoryShopRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
